...
(function($, window) {
	...
	var itemTemplate = '<div class="mui-slider-item mui-zoom-wrapper {{className}}"><div class="mui-zoom-scroller"><img id="imgid" src="{{src}}" data-preview-lazyload="{{lazyload}}" style="{{style}}" class="mui-zoom"></div></div>';
...
//		document.getElementById('imgid').addEventListener('touchmove',function(event){
//			animateNo=animateNo+90;
//			$("#imgid").rotate({ animateTo:animateNo });
//		});
