...
function cityObject(click_element_id,value_id,text_id,parent_id,managerName,methodName,item_id, item_name,refresh_method){
...
cityObject.prototype.refresh = function(){
	...
	doManager(this.managerName,this.methodName,parentValue,function(data){
		if(data.result){
